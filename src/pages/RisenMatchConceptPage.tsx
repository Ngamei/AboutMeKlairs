...
import { RisenMatchConceptSection } from '../components/RisenMatchConceptSection';
import { useLanguage } from '../lib/i18n';

export default function RisenMatchConceptPage() {
  const { t } = useLanguage();
